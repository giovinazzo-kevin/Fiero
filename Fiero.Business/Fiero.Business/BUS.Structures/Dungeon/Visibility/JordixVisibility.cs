namespace Fiero.Business
{
    ...
    /// </summary>
    sealed class JordixVisibility : Visibility
    {
        ...
        /// </param>
        public JordixVisibility(Func<int, int, bool> blocksLight, Action<int, int> setVisible, Func<int, int, int> getDistance)
        {
        ...
        public override void Compute(Coord origin, int rangeLimit)
        {
        ...
        void Compute(uint octant, Coord origin, int rangeLimit, uint x, Slope top, Slope bottom)
        {
