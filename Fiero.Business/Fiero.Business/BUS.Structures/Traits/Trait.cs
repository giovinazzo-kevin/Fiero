...
namespace Fiero.Business
{
    ...
    public static class Traits
    {
        ...
        public static readonly Trait Invulnerable = new(TraitName.Invulnerable, new EffectDef(EffectName.Invulnerable), [TraitName.Invulnerable]);
        public static readonly Trait Impassible = new(TraitName.Impassible, new EffectDef(EffectName.Impassible), [TraitName.Impassible]);
